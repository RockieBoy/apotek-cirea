...
import 'package:mobile_app_apotik_cirea/kelola_barang_non_medis/kelola/BarangNonMedisvalidate/BarangNonMedisCreateValidate.dart';



class TambahDataBarangNonMedis extends StatelessWidget {
  @override
                  ...
                  Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.pushReplacement(context,
                            MaterialPageRoute(builder: (context) {
                          return BarangNonMedisCreateValidate();
                        }));
                      },
                      child: const Text(
                        "Tambah Data",
