...
import 'package:mobile_app_apotik_cirea/kelola_barang_non_medis/kelola/BarangNonMedisvalidate/BarangNonMedisEditValidate.dart';


class EditDataBarangNonMedis extends StatelessWidget {
  @override
                  ...
                  Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.pushReplacement(context,
                            MaterialPageRoute(builder: (context) {
                          return BarangNonMedisEditValidate();
                        }));
                      },
                      child: const Text(
                        "Edit Data",
