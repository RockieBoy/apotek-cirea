...
import 'package:mobile_app_apotik_cirea/kelola_barang_non_medis/detail/BarangNonMedisvalidate/BarangNonMedisCreateValidate.dart';


class TambahDataBarangNonMedisDetail extends StatelessWidget {
  @override
                  ...
                  Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.pushReplacement(context,
                            MaterialPageRoute(builder: (context) {
                          return const DBarangNonMedisCreateValidate();
                        }));
                      },
                      child: const Text(
                        "Tambah Data",
