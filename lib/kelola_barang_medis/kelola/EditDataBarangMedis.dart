...
import 'package:mobile_app_apotik_cirea/kelola_barang_medis/kelola/BarangMedisvalidate/BarangMedisEditValidate.dart';


class EditDataBarangMedis extends StatelessWidget {
  @override
                  ...
                  Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.pushReplacement(context,
                            MaterialPageRoute(builder: (context) {
                          return BarangMedisEditValidate();
                        }));
                      },
                      child: const Text(
                        "Edit Data",
